...
import os
import struct
os.chdir('/Users/ishika/Desktop/API/Genomic-Model-Evaluation-API/src/socket_scripts/Apptainer/prediction_container_apptainer_updated/')
...
# ---------------------- %%%%%%%---------------
    ...
    if evaluator_json['request'] == "help":
        ...
        help_file = "/Users/ishika/Desktop/API/Genomic-Model-Evaluation-API/src/socket_scripts/Apptainer/prediction_container_apptainer_updated/predictor_help_message.json"
